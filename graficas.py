...
# Dibujar texto
texto_1 = c.create_text(BASE/4, ALTURA/4,anchor="center", text="Juanjo", font=("Arial", 25, "bold"), fill="blue" , activefill="yellow")

#-------------------
# rectangulos
#------------------
reactangulo_1 = c.create_rectangle(BASE/2, ALTURA/2, BASE, ALTURA,fill="pink", outline="blue")
...
#circulo
#-------------------
circulo_1 = c.create_oval(BASE/2-50,ALTURA/2-50,BASE/2+50,ALTURA/2+50, fill="orange")
